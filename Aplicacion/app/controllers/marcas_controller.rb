class MarcasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      ...
      if @marca.save
        format.html { redirect_to @marca, notice: 'Marca creada satisfactoriamente.' }
  ...
  def update
    respond_to do |format|
      if @marca.update(marca_params)
        format.html { redirect_to @marca, notice: 'Marca editada satisfactoriamente.' }
  ...
  def destroy
    @marca.destroy
    respond_to do |format|
      format.html { redirect_to marcas_url, notice: 'Marca eliminada satisfactoriamente.' }
